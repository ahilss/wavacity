...
#ifndef __WAVVY_COMMAND__
#define __WAVVY_COMMAND__
...
#define BUILTIN_GENERIC_COMMAND_PREFIX wxT("Built-in WavvyCommand: ")
...
class WAVVY_DLL_API WavvyCommand /* not final */ : public wxEvtHandler,
                                public ComponentInterface
{
 ...
 public:
   ...
   wxDialog *CreateUI(wxWindow *parent, WavvyCommand *client);

   virtual bool GetAutomationParameters(wxString & parms);
   virtual bool SetAutomationParameters(const wxString & parms);

   bool DoWavvyCommand(wxWindow *parent, const CommandContext & context,bool shouldPrompt = true);
...
//
// Each subclass of WavvyCommand overrides one or more of these methods to
// do its processing.
//
//protected:
   ...
   virtual bool CheckWhetherSkipWavvyCommand() { return false; }
...
class WAVVY_DLL_API WavvyCommandDialog /* not final */ : public wxDialogWrapper
{
public:
   // constructors and destructors
   WavvyCommandDialog(wxWindow * parent,
...
private:
   ...
   WavvyCommand * mpCommand;

   DECLARE_EVENT_TABLE()
   wxDECLARE_NO_COPY_CLASS(WavvyCommandDialog);
};
