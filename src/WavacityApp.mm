...
// Mac-only methods of class WavacityApp that use Objective-C are kept
// here so that WavacityApp.cpp can be just C++
...
void WavacityApp::MacActivateApp()
{
...
void WavacityApp::MacFinishLaunching()
{
