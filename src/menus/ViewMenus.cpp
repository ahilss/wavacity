...
void OnAdvancedVZoom(const CommandContext &context)
{
   ...
   bool checked = !gPrefs->ReadBool(wxT("/GUI/VerticalZooming"), false);
...
void OnShowExtraMenus(const CommandContext &context)
{
   ...
   bool checked = !gPrefs->ReadBool(wxT("/GUI/ShowExtraMenus"), false);
...
void OnShowClipping(const CommandContext &context)
{
   ...
   bool checked = !gPrefs->ReadBool(wxT("/GUI/ShowClipping"), false);
