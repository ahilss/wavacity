...
public:
   ...
   void PromptUser(EffectNoiseReduction *effect,
...
void EffectNoiseReduction::ShowInterfaceAsync(
   wxWindow &parent,
   const EffectDialogFactory &,
   bool forceModal,
   std::function<void (bool)> callback)
{
   ...
   mSettings->PromptUser(this, parent,
      bool(mStatistics), forceModal, callback);
}

void EffectNoiseReduction::Settings::PromptUser
(EffectNoiseReduction *effect, wxWindow &parent,
 bool bHasProfile, bool bAllowTwiddleSettings,
 std::function<void (bool)> callback)
{
   EffectNoiseReduction::Dialog *dlog = safenew EffectNoiseReduction::Dialog
      (effect, this, &parent, bHasProfile, bAllowTwiddleSettings);

   dlog->CentreOnParent();
   dlog->ShowModal([this, callback, dlog](int retCode) {
