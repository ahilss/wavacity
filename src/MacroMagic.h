...
#define DEFINE_IMAGE( name, initialiser, textual_name )  WAVVY_DLL_API teBmps name=-1;
#define DEFINE_COLOUR( name, initialiser, textual_name ) WAVVY_DLL_API int name=-1;
#define DEFINE_FONT( name, initialiser, textual_name )  WAVVY_DLL_API int name=-1;
...
#ifdef THEME_EXTERNS
#define DEFINE_IMAGE( name, initialiser, textual_name )  extern WAVVY_DLL_API teBmps name;
#define DEFINE_COLOUR( name, initialiser, textual_name ) extern WAVVY_DLL_API int name;
#define DEFINE_FONT( name, initialiser, textual_name ) extern WAVVY_DLL_API int name;
#define SET_THEME_FLAGS( flags )
#endif
