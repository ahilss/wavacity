...
void ProjectFileManager::ShowOpenDialog(FileNames::Operation op,
   const FileNames::FileType &extraType,
   std::function<void (const wxArrayString&)> callback)
{
   ...
   FileDialogWrapper *dlog = safenew FileDialogWrapper(nullptr,
   ...
   dlog->ShowModal([op, callback, fileTypes, dlog](int dialogResult) {
