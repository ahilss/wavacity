...
void PluginManager::ShowManager(wxWindow *parent, EffectType type, std::function<void (bool)> callback)
{
   CheckForUpdates();

   PluginRegistrationDialog *dlg = safenew PluginRegistrationDialog(parent, type);
