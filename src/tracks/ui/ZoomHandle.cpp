...
HitTestPreview ZoomHandle::HitPreview
   (const wxMouseState &state, const WavacityProject *WXUNUSED(pProject))
{
...
(const TrackPanelMouseEvent &evt, WavacityProject *)
{
...
UIHandle::Result ZoomHandle::Cancel(WavacityProject*)
{
