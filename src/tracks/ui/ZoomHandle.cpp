...
HitTestPreview ZoomHandle::HitPreview
   (const wxMouseState &state, const WavvyProject *WXUNUSED(pProject))
{
...
(const TrackPanelMouseEvent &evt, WavvyProject *)
{
...
UIHandle::Result ZoomHandle::Cancel(WavvyProject*)
{
