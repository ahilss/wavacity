...
Importer::GetFileTypes( const FileNames::FileType &extraType )
{
   ...
   FileExtensions extraExtensions = FileNames::WavvyProjects.extensions;
   ...
   FileExtensions allList = FileNames::WavvyProjects.extensions, newList;
...
bool Importer::Import( WavvyProject &project,
                     ...
                     TranslatableString &errorMessage)
{
   ...
   if (FileNames::IsMidi(fName)) {
      errorMessage = XO(
"\"%s\" \nis a MIDI file, not an audio file. \nWavvy cannot open this type of file for playing, but you can\nedit it by clicking File > Import > MIDI.")
         .Format( fName );
      return false;
   }
#endif
   ...
   if (wxFileName(fName).GetExt() == wxT("doc")) {
      errorMessage =
         XO("\"%s\" \nis a not an audio file. \nWavvy cannot open this type of file.")
         .Format( fName );
      return false;
   }
   ...
   // Wavvy supports this format, but support was not compiled in.
   ...
   for (const auto &unusableImportPlugin : sUnusableImportPluginList())
   {
      ...
      {
         errorMessage = XO("This version of Wavvy was not compiled with %s support.")
...
"\"%s\" is an audio CD track. \nWavvy cannot open audio CDs directly. \nExtract (rip) the CD tracks to an audio format that \nWavvy can import, such as WAV or AIFF.")
            .Format( fName );
         return false;
      }
      ...
      if ((extension.IsSameAs(wxT("m3u"), false))||(extension.IsSameAs(wxT("ram"), false))||(extension.IsSameAs(wxT("pls"), false))) {
         errorMessage = XO(
/* i18n-hint: %s will be the filename */
"\"%s\" is a playlist file. \nWavvy cannot open this file because it only contains links to other files. \nYou may be able to open it in a text editor and download the actual audio files.")
            .Format( fName );
         return false;
      }
      ...
      if ((extension.IsSameAs(wxT("wma"), false))||(extension.IsSameAs(wxT("asf"), false))) {
         errorMessage = XO(
/* i18n-hint: %s will be the filename */
"\"%s\" is a Windows Media Audio file. \nWavvy cannot open this type of file due to patent restrictions. \nYou need to convert it to a supported audio format, such as WAV or AIFF.")
            .Format( fName );
         return false;
      }
      ...
      if ((extension.IsSameAs(wxT("aac"), false))||(extension.IsSameAs(wxT("m4a"), false))||(extension.IsSameAs(wxT("m4r"), false))||(extension.IsSameAs(wxT("mp4"), false))) {
         errorMessage = XO(
/* i18n-hint: %s will be the filename */
"\"%s\" is an Advanced Audio Coding file.\nWithout the optional FFmpeg library, Wavvy cannot open this type of file.\nOtherwise, you need to convert it to a supported audio format, such as WAV or AIFF.")
            .Format( fName );
         return false;
      }
      ...
      if ((extension.IsSameAs(wxT("m4p"), false))) {
         errorMessage = XO(
/* i18n-hint: %s will be the filename */
"\"%s\" is an encrypted audio file. \nThese typically are from an online music store. \nWavvy cannot open this type of file due to the encryption. \nTry recording the file into Wavvy, or burn it to audio CD then \nextract the CD track to a supported audio format such as WAV or AIFF.")
            .Format( fName );
         return false;
      }
      ...
      if ((extension.IsSameAs(wxT("ra"), false))||(extension.IsSameAs(wxT("rm"), false))||(extension.IsSameAs(wxT("rpm"), false))) {
         errorMessage = XO(
/* i18n-hint: %s will be the filename */
"\"%s\" is a RealPlayer media file. \nWavvy cannot open this proprietary format. \nYou need to convert it to a supported audio format, such as WAV or AIFF.")
            .Format( fName );
         return false;
      }
      ...
      if ((extension.IsSameAs(wxT("kar"), false))||(extension.IsSameAs(wxT("mod"), false))||(extension.IsSameAs(wxT("rmi"), false))) {
         errorMessage = XO(
/* i18n-hint: %s will be the filename */
"\"%s\" is a notes-based file, not an audio file. \nWavvy cannot open this type of file. \nTry converting it to an audio file such as WAV or AIFF and \nthen import it, or record it into Wavvy.")
            .Format( fName );
         return false;
      }
...
"\"%s\" is a Wavpack audio file. \nWavvy cannot open this type of file. \nYou need to convert it to a supported audio format, such as WAV or AIFF.")
      ...
      if ((extension.IsSameAs(wxT("ac3"), false))) {
         errorMessage = XO(
/* i18n-hint: %s will be the filename */
"\"%s\" is a Dolby Digital audio file. \nWavvy cannot currently open this type of file. \nYou need to convert it to a supported audio format, such as WAV or AIFF.")
            .Format( fName );
         return false;
      }
...
"\"%s\" is a video file. \nWavvy cannot currently open this type of file. \nYou need to extract the audio to a supported format, such as WAV or AIFF.")
      ...
      errorMessage = XO(
/* i18n-hint: %s will be the filename */
"Wavvy did not recognize the type of the file '%s'.\n\n%sFor uncompressed files, also try File > Import > Raw Data.")
         .Format( fName,
   ...
   else
   {
      ...
      errorMessage = XO(
/* i18n-hint: %s will be the filename */
"Wavvy recognized the type of the file '%s'.\nImporters supposedly supporting such files are:\n%s,\nbut none of them understood this file format.")
