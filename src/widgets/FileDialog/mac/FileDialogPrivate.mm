...
void FileDialog::SetupExtraControls(WXWindow nativeWindow)
{
    ...
    if ( m_useFileTypeFilter || HasUserPaneCreator() )
    {
        ...
        //
        //   2021-02-17 13:52:14.550 Wavacity[69217:891282] warning: <NSRemoteView: 0x7f92f4e67410 com.apple.appkit.xpc.openAndSavePanelService ((null)) NSSavePanelService> ignoring attempt to mutate its subviews (
