...
class LWSlider
{
 ...
 public:
   ...
   void ShowDialog(std::function<void (bool)> callback = nullptr);
   void ShowDialog(wxPoint pos, std::function<void (bool)> callback = nullptr);
 ...
 private:
   ...
   void DoShowDialog(wxPoint pos, std::function<void (bool)> callback = nullptr);
...
class ASlider /* not final */ : public wxPanel
{
 ...
 public:
   ...
   void Increase(float steps);
   void Decrease(float steps);
   void ShowDialog(wxPoint pos = wxPoint(-1, -1),
