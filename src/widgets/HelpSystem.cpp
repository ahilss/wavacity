...
const wxString HelpSystem::HelpServerHomeDir = wxT("/wavvy/manual.html");
const wxString HelpSystem::HelpServerManDir = wxT("/wavvy/manual.html");
#endif
...
{
   wxDialogWrapper *dlog = safenew wxDialogWrapper(parent, wxID_ANY,
                dlogTitle,
   ...
   dlog->Center();
   dlog->ShowModal([dlog] (int retCode) {
      delete dlog;
   });
}
