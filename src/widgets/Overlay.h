...
#ifndef __WAVVY_OVERLAY__
#define __WAVVY_OVERLAY__
...
This is a brief guide to Wavvy redisplay -- it may not be complete. It
is my attempt to understand the complicated graphics strategy.

One basic idea is that redrawing waveforms is rather slow, so Wavvy
...
Wavvy, the "2-level" invalidation works like this: Anything
...
existing bitmap can be used for waveform images. Wavvy also
